...
const InitialTasks = [
  ...
  { id: '2', title: 'Something more', state: 'Default' },
  { id: '3', title: 'Something else', state: 'Pinned' },
  { id: '4', title: 'Something again', state: 'Default' },
  { id: '5', title: 'Something', state: 'Default' },
  { id: '6', title: 'Something more', state: 'Archieved' },
  { id: '7', title: 'Something else', state: 'Default' },
  { id: '8', title: 'Something again', state: 'Default' },
];
